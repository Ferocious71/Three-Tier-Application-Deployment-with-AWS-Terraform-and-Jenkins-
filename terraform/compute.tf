resource "aws_instance" "mongodb" {
  ...
  security_groups = [aws_security_group.sal-mongo_sg.id]  # Use direct reference
...
resource "aws_instance" "backend" {
  ami           = "ami-04b4f1a9cf54c11d0"
  instance_type = var.instance_type
  security_groups = [aws_security_group.sal-backend_sg.id]  # Use direct reference
  key_name      = var.key_name
...
resource "aws_instance" "frontend" {
  ami           = "ami-04b4f1a9cf54c11d0"
  instance_type = var.instance_type
  security_groups = [aws_security_group.sal-frontend_sg.id]  # Use direct reference
  key_name      = var.key_name
...
resource "aws_instance" "jenkins" {
  ...
  security_groups = [aws_security_group.sal-jenkins_sg.id]  # Use direct reference
  key_name      = var.key_name
